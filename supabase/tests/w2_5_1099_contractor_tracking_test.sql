...
insert into accounting_periods (id, org_id, period_start, period_end, status) values
  ('00000000-0000-0000-0000-0000000009P5', '00000000-0000-0000-0000-0000000009B1', date '2025-01-01', date '2025-12-31', 'open'),
  ('00000000-0000-0000-0000-0000000009P6', '00000000-0000-0000-0000-0000000009B1', date '2026-01-01', date '2026-12-31', 'open');
...
select _nec_pay('00000000-0000-0000-0000-0000000EE001','00000000-0000-0000-0000-0000000009P5', date '2025-03-01', 120000);
select _nec_pay('00000000-0000-0000-0000-0000000EE002','00000000-0000-0000-0000-0000000009P5', date '2025-04-01', 90000);
-- Card Contractor: $2,000 by card only → $0 reportable.
select _nec_pay('00000000-0000-0000-0000-0000000EE003','00000000-0000-0000-0000-0000000009P5', date '2025-05-01', 200000);
-- Utility Corp (not eligible): $5,000 check → must NOT appear.
select _nec_pay('00000000-0000-0000-0000-0000000EE004','00000000-0000-0000-0000-0000000009P5', date '2025-06-01', 500000);
...
insert into journal_entries (id, org_id, entry_date, period_id, status, source, memo, idempotency_key, posted_by, reverses_id)
  values ('00000000-0000-0000-0000-0000000EE0R1','00000000-0000-0000-0000-0000000009B1', date '2025-03-02',
          '00000000-0000-0000-0000-0000000009P5','posted','manual','reversal','ee0r1',
          '00000000-0000-0000-0000-0000000009c1','00000000-0000-0000-0000-0000000EE001');
insert into journal_lines (entry_id, org_id, account_id, amount_minor, side) values
  ('00000000-0000-0000-0000-0000000EE0R1','00000000-0000-0000-0000-0000000009B1','00000000-0000-0000-0000-00000009A100', 120000, 'D'),
  ('00000000-0000-0000-0000-0000000EE0R1','00000000-0000-0000-0000-0000000009B1','00000000-0000-0000-0000-00000009A600', 120000, 'C');
