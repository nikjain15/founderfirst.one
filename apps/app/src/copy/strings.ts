...
export const COPY = {
  ...
  connections: {
    ...
    lead: "Bring your money into Penny and share your books. Pick a job to start — including sending invoices and tracking bills.",
    ...
    menu: {
      ...
      invoicingDesc: "Create and send invoices, track who's paid — with gentle reminders.",
