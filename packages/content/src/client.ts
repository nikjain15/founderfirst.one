...
import { Page, FaqEntry, type Surface } from "./schema";

// NOTE: this client covers PAGES only. Email copy is not modelled here — it
// lives in the existing `email_templates` table (single source of truth, edited
// in admin EmailHub). See GAME_PLAN §6.
