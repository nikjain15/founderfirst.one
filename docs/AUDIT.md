...
**Coverage delta:** +14 ledger rows, all ⬜ (baseline + per-PR red-team, formal stress pass pending). RV2-A2 adds the `filing-export` row (structured per-suite export round-trips + ties to worksheet/TB).
